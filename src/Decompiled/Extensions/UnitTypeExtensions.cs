...
namespace CodeCave.Revit.Toolkit
{
    ...
    {
        private static readonly Dictionary<UnitType, string> utToCatalog;
        private static readonly Dictionary<UnitType, UnitGroup> utGroups;
        ...
        {
            utToCatalog = new Dictionary<UnitType, string>
            {
            ...
            utGroups = new Dictionary<UnitType, UnitGroup>
            {
            ...
            parameterTypes = new Dictionary<UnitType, ParameterType>
            {
                // TODO: figure out mappings for these types.
        ...
        {
            return utToCatalog.TryGetValue(unitType, out catalogString);
        }
        ...
        {
            return utGroups.TryGetValue(unitType, out group);
        }
